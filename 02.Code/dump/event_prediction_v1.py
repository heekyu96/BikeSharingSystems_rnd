...
class StationDataset(Dataset):
    def __init__(self, input_seq_len, output_seq_len, upper_bound, lower_bound, station_cnt_lock=-1):
...
class Prediction_Model_v3(nn.Module):
    def __init__(
        self,
        unit_input_dim,
        unit_hidden_dim,
...
historical_station_dataset = StationDataset(
    input_seq_len, output_seq_len, upper_bound, lower_bound, station_cnt_lock
)
